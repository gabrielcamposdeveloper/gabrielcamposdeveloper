# Hi there! I'm Gabriel Campos 👋

**Senior Full Stack Engineer | C# | .NET | Angular | React | Node.js | Microservices | Cloud & DevOps**
...
*   **Frontend & Mobile:** Angular, React, Next.js, TypeScript, RxJS, Tailwind CSS, Ionic
*   **Backend & Architecture:** C#, .NET, Node.js, Python, GraphQL
*   **Databases & Messaging:** SQL Server, PostgreSQL, MongoDB, Redis, Apache Kafka, RabbitMQ
*   **Cloud & DevOps:** Azure, AWS, Docker, Kubernetes, Azure DevOps

### 🧩 Featured Projects & Extensions

- 🔗 **[M0NGE React Extension Pack](https://marketplace.visualstudio.com/items?itemName=M0NGE.m0nge-react-extension-pack&ssr=false#review-details)**: VS 
